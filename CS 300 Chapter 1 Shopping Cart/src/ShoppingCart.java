...
/**
 * The Shopping Cart Class contains methods for the shopping cart class/program. They run a variety
 * of different operations for each method that all contribute to the shopping cart application.
 * 
 */
public class ShoppingCart {
   ...
   * 
   * @param itemToRemove The item to remove from Market Items
   * @param cart shopping cart
   * @return the updated count after the selected item is removed from the list. If the item is not
   *         found it returns the original value of count and displays a warning/error message to
   *         the console.
   */
  ...
  /**
   * Main method used to run the function shopping cart program and call the necessary supporting
   * methods.
   * 
   * @param args
   */
  ...
  public static void main(String[] args) {
    ...
    while (!quit) {
      ...
      if (userInputFirstLetter == 'p') {
        ...
        // found
        System.out.println("The number of occurrences of " + getItemDescription(index) + " (id #"
            + index + ") is: " + occurrencesOf(index, cart, count));
