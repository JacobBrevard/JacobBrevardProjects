...
/**
 * The Shopping Cart Test Class contains a test bench for the shopping cart class/program. This runs
 * a variety of tests to confirm the accuracy of the program.
 */

public class ShoppingCartTests {

  /**
   * (TEST 1) Checks whether the total number of items within the cart is incremented after adding
   * one item
   * 
  ...
  /**
   * (TEST 2) Checks whether add and OccurrencesOf return the correct output when only one item is
   * added to the cart
   * 
  ...
  /**
   * (TEST 4) Checks that the correct output is returned when the user tries to add too much items
   * to the cart exceeding its capacity.
   * 
  ...
  /**
   * (TEST 5) Checks that when only one attempt to remove an item present in the cart is made, only
   * one occurrence of that item is removed from the cart.
   * 
  ...
  /**
   * (TEST 6) Checks that remove returns false when the user tries to remove an item not present
   * within the cart
   * 
  ...
  /**
   * (TEST 7) Checks that the get sub total price method returns the correct total for the prices of
   * the items within the cart.
   * 
  ...
  /**
   * (TEST 8) Calls the Print Market Catalog method to check if it prints out the correct output.
   * 
  ...
  /**
   * (TEST 9) Checks that remove returns 0 when the user tries to remove an item from an empty cart
   * 
  ...
  /**
   * (TEST 10) Checks that the get sub total price method returns the correct total for the prices
   * of the items within the cart. Uses a different cart capacity.
   * 
  ...
  /**
   * (TEST 11) Checks that the get sub total price method returns the correct total for the prices
   * of the items within the cart. Uses a different cart capacity.
   * 
  ...
  public static void main(String[] args) {
    ...
    // Test 4
    System.out.println(
        "TEST 4: testAddOccurrencesOfDuplicateItems(): " + testAddOccurrencesOfDuplicateItems());
    System.out.println("");

    // Test 5
    System.out.println("TEST 5: testRemoveItemNotFoundInCart(): " + testRemoveItemNotFoundInCart());
    System.out.println("");

    // Test 6
    System.out.println(
        "TEST 6: testRemoveOnlyOneOccurrenceOfItem(): " + testRemoveOnlyOneOccurrenceOfItem());
    System.out.println("");
    ...
    // Test 10
    System.out.println("TEST 10: testGetSubTotalPriceSecond(): " + testGetSubTotalPriceSecond());
    System.out.println("");
